Trading _Agents_ 기술 가이드 v0.2.3 · 2026.04 최신
...
02전체 아키텍처 03애널리스트 팀 04리서처 팀 05트레이더 에이전트 06리스크 관리팀 07에이전트 통신 프로토콜

설치 및 사용

08설치 09API 키 설정 10CLI 사용법 11Python 패키지 사용 12설정 옵션

성능 및 연구

13성능 벤치마크 14LangGraph 기반 설계 15한계 및 주의사항 16기술 스택 17인용 및 링크

레퍼런스

16인용 및 링크

TauricResearch · Multi-Agent LLM Financial Trading
